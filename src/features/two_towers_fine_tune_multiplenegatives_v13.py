...
checkpoints_dir = 'models/two_tower_checkpoints_multiplenegatives_v13'
...
class TwoTowerSimilarityModel(nn.Module):
    ...
    def forward(self, questions: List[str], paragraphs: List[str]):
        ...
        # Embed paragraphs directly, without handling them as lists of sentences
        paragraph_embeddings = torch.stack([self.paragraph_model.embed_text(paragraph) for paragraph in paragraphs])
