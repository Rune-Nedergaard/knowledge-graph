...
checkpoints_dir = 'models/two_tower_checkpoints_multiplenegatives_v16'
...
val_dataloader = DataLoader(val_dataset, batch_size=2, shuffle=False, collate_fn=collate_fn, num_workers=0)
