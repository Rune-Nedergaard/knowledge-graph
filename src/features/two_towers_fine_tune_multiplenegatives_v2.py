...
checkpoints_dir = 'models/two_tower_checkpoints_multiplenegatives_v2'
...
optimizer = AdamW(two_tower_model.parameters(), lr=1e-5, weight_decay=0.01)
...
train_dataloader = DataLoader(train_dataset, batch_size=64, shuffle=True, collate_fn=collate_fn, num_workers=16)
val_dataloader = DataLoader(val_dataset, batch_size=64, shuffle=False, collate_fn=collate_fn, num_workers=16)
