...
plt.plot(old_ce_train_losses, label='Old CE Training Loss', linestyle='-', linewidth=2, color='C2')
plt.plot(old_ce_test_losses, label='Old CE Test Loss', linestyle='--', linewidth=2, color='C2')
